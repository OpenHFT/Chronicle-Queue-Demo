...
Save the file as something like test-requirements.adoc in your documentation directory so the entire team can reference it. This ensures everyone uses the same guidelines for creating or extending unit tests and YAML-based tests.
