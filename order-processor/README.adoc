...
This project uses link:aide/README.adoc[AIDE] to maintain consistency between requirements, tests, and code. See https://github.com/peter-lawrey/aide[AIDE Project] for more information.
